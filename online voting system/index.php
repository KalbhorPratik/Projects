...
<head>
	<title>Login - OnlineVotingSystem</title>
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				?>
					...
					<form method="POST">
						...
						<div class="input-group mb-2">
							...
							<input type="text" name="su_contact_no" class="form-control input_pass" value="" placeholder="Contact #" required />
						</div>		
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
				...
				?>
					...
					<div class="mt-4">
						...
						<div class="d-flex justify-content-center links ">
							<a href="#" class="d-flex justify-content-center links text-white">Forgot your password?</a>
						</div>
					</div>
				<?php
				}
				...
				<?php
					...
					{
					?>
						<span class="bg-white text-success text-center "> Your account has been created successfully! </span>

					<?php
					}else if(isset($_GET['invalid']))
					{
					?>
						<span class="bg-white text-danger text-center "> Passwords mismatched,Please try again!!!</span>
					<?php
					}else if(isset($_GET['not_registered']))
					{
					?>
						<span class="bg-white text-warning text-center my-3"> Sorry, you are not regsitered!</span>
					<?php
					}else if(isset($_GET['invalid_access']))
					{
					?>
						<span class="bg-white text-danger text-center my-3	"> Invalid username or passsword!</span>
					<?php
					}
				?>
